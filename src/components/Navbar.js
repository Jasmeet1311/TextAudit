        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              <Link className={`nav-link ${props.active}`} aria-current="page" to="/">
                Home
              </Link>
            </li>
            <li className="nav-item">
              <Link className={`nav-link ${props.active}`} to="/about">
                About
              </Link>
            </li>
          </ul>
...
Navbar.propTypes = {
  title: PropTypes.string.isRequired, // title is required if not give it will show error
};
Navbar.defaultProps = {
  title: "Set title",
};
